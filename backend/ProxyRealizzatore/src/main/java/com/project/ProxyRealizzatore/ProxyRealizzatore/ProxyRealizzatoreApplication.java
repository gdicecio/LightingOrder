...
import com.project.ProxyRealizzatore.ProxyRealizzatore.web.KeyArtemis;
import com.project.ProxyRealizzatore.ProxyRealizzatore.web.KeyCertificate;
...
public class ProxyRealizzatoreApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(ProxyRealizzatoreApplication.class, args);
	}
