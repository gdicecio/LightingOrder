...
import com.project.ProxyAccoglienza.web.KeyArtemis;
import com.project.ProxyAccoglienza.web.KeyCertificate;
...
public class ProxyAccoglienzaApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(ProxyAccoglienzaApplication.class, args);
	}
